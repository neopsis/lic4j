...
public class LicenseUtils {
     ...
     */
    public static boolean verify(AbstractLicense lic, final String publicKey) throws GeneralSecurityException {
     ...
     * @throws GeneralSecurityException if any exception was thrown
     */
    public static boolean verify(AbstractLicense lic, final String publicKey, String sigAlgorithm, String provider)
     ...
     * @throws GeneralSecurityException if any exception was thrown
     */
    public static void sign(AbstractLicense lic, final String privateKey) throws GeneralSecurityException {
     ...
     * @throws GeneralSecurityException if any exception was thrown
     */
    public static void sign(AbstractLicense lic, final String privateKey, String sigAlgorithm, String provider)
            throws GeneralSecurityException {
     ...
     */
    public static String toJson(AbstractLicense license) {
     ...
     * @return the license as Json string
     */
    public static String toJson(AbstractLicense license, boolean prettyFormat) {
     ...
     * must be a serialization of {@link AbstractLicense} subclass
     *
     * @param json a license as JSON object
     * @return  license as Java object
     */
    public static <T extends AbstractLicense> T toObject(String json, Class<T> clazz)
     ...
     */
    public static void writeLicense(AbstractLicense license, String fileName) throws IOException, GeneralSecurityException {
     ...
     * @throws IOException error on file write occurred
     */
    public static <T extends AbstractLicense> T readLicense(String fileName, Class<T> clazz)
